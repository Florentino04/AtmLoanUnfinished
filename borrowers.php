						...
						$i = 1;
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Account # :<b><?php echo $row['tax_id'] ?></small></b></p>
...
<script>
	...
	$('body').on('click','#new_borrower',function(){
		uni_modal("New borrower","manage_borrower.php",'modal-lg')
	})
	$('body').on('click','.edit_borrower',function(){
		uni_modal("Edit borrower","manage_borrower.php?id="+$(this).attr('data-id'),'modal-lg')
	})
	$('body').on('click','.delete_borrower',function(){
