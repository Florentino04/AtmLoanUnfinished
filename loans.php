						...
						<?php
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Semi Monthly Payable Amount: <b><?php echo number_format($semi,2) ?></small></b></p>
...
<script>
	...
	$('body').on('click','#new_application',function(){
		...
		uni_modal("New Loan Application","manage_loan.php",'modal-lg')
	})
	$('body').on('click','.edit_loan',function(){

		uni_modal("Edit Loan","manage_loan.php?id="+$(this).attr('data-id'),'modal-lg')
	})
