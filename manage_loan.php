...
<div class="container-fluid">
	...
	<form action="" id="loan-application">
		...
		<div class="row">
			...
			<textarea name="purpose" id="" cols="100" rows="2" class="form-control"><?php echo isset($purpose) ? $purpose : '' ?></textarea>
		</div>
		<div class="form-group col-md-6">
			<label class="control-label">Cut-Off Day</label>
			<input type="date" name="cutoff" class="form-control"  id="" value="<?php echo isset($cutoff) ? $cutoff : '' ?>">
		</div>
